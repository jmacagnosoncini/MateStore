...
const renderFilterProducts = () => {
    ...
    const filteredProductsPaginated = filteredProducts.slice(appState.currentProductsIndex * 6, (appState.currentProductsIndex + 1) * 6);
...
const updatePagination = () => {
    const filteredProducts = appState.activeFilter ? productos.filter(product => product.category === appState.activeFilter) : productos;
    appState.productsLimit = Math.ceil(filteredProducts.length / 6); 
    renderProducts(filteredProducts.slice(appState.currentProductsIndex * 6, (appState.currentProductsIndex + 1) * 6));
    generatePagination();
...
productsContainer.addEventListener('click', (event) => {
    if (event.target.classList.contains("btn-sumar") || event.target.classList.contains("btn-restar")) {
    ...
    productsCart.innerHTML = cart
        ...
        <div class="cart-item">
            ...
            <div class="item-info">
                ...
                <span class="item-price">${(product.precio * product.quantity).toFixed(2)} USD</span>
            </div>
